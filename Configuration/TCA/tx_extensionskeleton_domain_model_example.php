    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_extensionskeleton_domain_model_example',
                'foreign_table_where' => 'AND tx_extensionskeleton_domain_model_example.pid=###CURRENT_PID### AND tx_extensionskeleton_domain_model_example.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
